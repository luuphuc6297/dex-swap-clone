...
import { IconUSFlag } from 'components/Tailwind/icons/icon-us-flag';
import Button from 'components/Tailwind/ui/button';
import CoinListBox from 'components/Tailwind/ui/coin-listbox';
import { Tab, TabPanel, TabPanels } from 'components/Tailwind/ui/tab';
    ...
    return (
        <div className={cn(className)}>
            ...
            >
                ...
                <span className="my-6 block h-[1px] border-b border-dashed border-b-gray-200 dark:border-b-gray-700" />
                <TabPanels>
