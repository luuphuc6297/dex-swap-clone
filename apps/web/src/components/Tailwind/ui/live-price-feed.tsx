        ...
        >
            <div className="w-full flex-col">
                <div className="mb-3 flex items-center">
                    ...
                    <Typography
                        variant="h4"
                        className="text-sm font-medium text-gray-900 ltr:ml-3 rtl:mr-3 dark:text-white"
                    >
                        {name}
                    </Typography>
                </div>
            ...
            <div className="h-20 w-full" data-hello={isChangePositive ? '#22c55e' : '#D6455D'}>
...
export default function PriceFeedSlider({
    ...
    return isMounted && ['xs', 'sm', 'md', 'lg', 'xl', '2xl'].indexOf(breakpoint) !== -1 ? (
        <Swiper
            modules={[A11y]}
            spaceBetween={24}
            slidesPerView={1}
