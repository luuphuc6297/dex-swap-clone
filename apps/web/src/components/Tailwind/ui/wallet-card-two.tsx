...
import { LongArrowUp } from 'components/Tailwind/icons/long-arrow-up';
...
export default function WalletCard() {
    ...
    return (
        <div className="rounded-lg bg-transparent  ">
            <Typography
                variant="h3"
                className="mb-10 text-center text-base font-medium uppercase md:mb-3 ltr:lg:text-left rtl:lg:text-right xl:mb-10"
            >
                Available Coin
            </Typography>
                    ...
                    <PieChart className="h-[290px] w-[290px] md:scale-[.90] xl:scale-100">
                        <Pie
                            ...
                            onMouseMove={(data) => {
                                ...
                                setPercentage(data.payload.payload && data.payload.payload.volume);
                            }}
                        >
