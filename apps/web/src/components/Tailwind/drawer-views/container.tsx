import { DRAWER_VIEW, useDrawer } from 'components/Tailwind/drawer-views/context';
...
// dynamic imports
const Sidebar = dynamic(() => import('tailwind-layouts/sidebar/_default'));
const DrawerFilters = dynamic(() => import('components/Tailwind/search/filters'));
const DrawerMenu = dynamic(() => import('tailwind-layouts/sidebar/_layout-menu'));
