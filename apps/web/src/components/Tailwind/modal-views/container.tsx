...
import { MODAL_VIEW, useModal } from 'components/Tailwind/modal-views/context';
// import Followers from 'components/Tailwind/profile/followers-view';
...
// dynamic imports
const SearchView = dynamic(() => import('components/Tailwind/search/view'));
const SelectWallet = dynamic(() => import('components/Tailwind/nft/select-wallet'));
