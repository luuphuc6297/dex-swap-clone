...
import { LinkIcon } from 'components/Tailwind/icons/link-icon';
import { LongArrowLeft } from 'components/Tailwind/icons/long-arrow-left';
import { LongArrowRight } from 'components/Tailwind/icons/long-arrow-right';
    ...
    },
    {
        ...
        Cell: ({ cell: { value } }) => (
            <div className="-tracking-[1px] ltr:text-right rtl:text-left">
                ...
                <span className="text-gray-600 dark:text-gray-400">${value.usdBalance}</span>
            </div>
        ),
        minWidth: 200,
        maxWidth: 300,
