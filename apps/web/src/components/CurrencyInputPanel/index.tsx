...
const CurrencyInputPanel = memo(function CurrencyInputPanel({
    ...
    const isAtPercentMax =
        (maxAmount && value === maxAmount.toExact()) || (lpPercent && lpPercent === '100');
        ...
        <SwapUI.CurrencyInputPanel
            ...
            top={
                <>
                        ...
                        >
                            <Flex alignItems="center" justifyContent="space-between">
                                ...
                                {currencyLoading ? null : pair ? (
                                    <p
                                        className="block text-xs tracking-tighter text-gray-600 dark:text-gray-400 sm:text-sm"
                                        id="pair"
                                    >
                    ...
                    {account && (
                        <Text
                            className="text-xs tracking-tighter text-gray-600 dark:text-gray-400 sm:text-sm"
