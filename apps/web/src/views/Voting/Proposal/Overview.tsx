...
const Overview = () => {
    ...
    const {
        ...
        data: votes,
        mutate: refetch,
    } = useSWRImmutable(proposal ? ['proposal', proposal, 'votes'] : null, async () =>
        getAllVotes(proposal)
    );
    ...
    const isPageLoading =
        ...
        proposalLoadingStatus === FetchStatus.Fetching;
        ...
        <Container py="40px">
            <Box mb="40px">
                <Link href="/voting" passHref>
                    <Button
                        variant="text"
                        startIcon={<ArrowBackIcon color="primary" width="24px" />}
                        px="0"
                    >
