...
const EventStepsSection: React.FC<React.PropsWithChildren<EventStepsProps>> = ({
    ...
    const stepsConfig = stepsConfigBuilder({
        t,
        eventInfos,
        userInfos,
        userStatus,
    ...
    const isMintingFinished =
        userInfos && eventInfos && eventInfos.maxSupply === eventInfos.totalSupplyMinted;
    return (
                    ...
                    {isMintingFinished ? (
                        <Flex flexDirection="column" alignItems="center">
                            <Text fontSize="16px" color="text" textAlign="center">
                                {t(
                                    'The minting period is now over: all 10,000 bunnies have now been minted.'
                                )}
                            </Text>
