    ...
    const handleCurrencySelect = useCallback(
        (currencyNew: Currency, currencyIdOther?: string): (string | undefined)[] => {
            ...
            const isETHOrWETHNew =
                currencyNew?.isNative ||
                (chainId !== undefined && currencyIdNew === WNATIVE[chainId]?.address);
            ...
            <CardBody>
                <ResponsiveTwoColumns>
                    <AutoColumn alignSelf="stretch">
                        <p className="mb-4 text-left font-medium tracking-tighter text-gray-900 dark:text-white xl:text-2xl 3xl:mb-8 3xl:text-[32px]">
                            Choose Token Pair
                        </p>
                        ...
                        <StableConfigContext.Provider value={stableConfig}>
                            <AddStableLiquidity currencyA={baseCurrency} currencyB={quoteCurrency}>
                                {(props) => (
                                    <StableFormView
                                        {...props}
                                        stableLpFee={stableConfig?.stableSwapConfig?.stableLpFee}
                                    />
                                )}
                            </AddStableLiquidity>
...
const SELECTOR_TYPE_T = {
    ...
    [SELECTOR_TYPE.V2]: <Trans>Add Liquidity</Trans>,
