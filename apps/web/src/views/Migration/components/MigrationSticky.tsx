...
export const TEXT = {
    v2: {
        ...
        steps: [
            ...
            },
            {
                ...
                subTitle: (
                    <Trans>Each farm and pool has to be individually enabled before staking.</Trans>
                ),
    ...
    v3: {
        title: <Trans>Itemswap Migration</Trans>,
        steps: [
            {
                title: <Trans>Unstaking from Farms</Trans>,
                subTitle: (
                    <Trans>
                        All the earned CAKE will be harvested to your wallet upon unstake.
                    </Trans>
            ...
            {
                title: <Trans>Removing liquidity</Trans>,
                subTitle: (
                    <Trans>All trading fee earnings are included in the tokens returned.</Trans>
                ),
                button: <Trans>Next Steps</Trans>,
            },
            {
                ...
                subTitle: (
                    <Trans>
                        Before you provide liquidity, please read make sure you are familiar with
...
const MigrationSticky: React.FC<React.PropsWithChildren<MigrationStickyProps>> = ({
    step,
    handleClick,
    version,
}) => {
