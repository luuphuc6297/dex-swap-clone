...
const ActivityHistory: React.FC<React.PropsWithChildren<ActivityHistoryProps>> = ({
    collection,
}) => {
    ...
    useEffect(() => {
        const slice = activityData.slice(
            MAX_PER_PAGE * (currentPage - 1),
                                    ...
                                    activitiesSlice.map((activity) => {
                                        const nftMeta = nftMetadata.find(
                                            (metaNft) =>
                                                ...
                                                isAddress(metaNft.collectionAddress) ===
                                                    isAddress(activity.nft?.collection.id)
                                        );
                                        return (
                                            <ActivityRow
