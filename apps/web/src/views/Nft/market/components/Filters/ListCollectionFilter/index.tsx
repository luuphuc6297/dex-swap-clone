...
export const ListCollectionFilter: React.FC<React.PropsWithChildren<ListCollectionFilterProps>> = ({
    ...
    const [orderState, setOrderState] = useState<ListOrderState>({
        orderKey: 'label',
        orderDir: 'asc',
    });
                    ...
                    <Box maxWidth="375px" ref={menuRef}>
                        ...
                        <Flex alignItems="center" p="16px">
                            <FilterButton onClick={toggleSort('name')} style={{ flex: 1 }}>
                                ...
                                <Box width="18px">
                                    {orderKey === 'name' && orderDir === 'asc' && (
                                        <ArrowUpIcon width="18px" color="secondary" />
                                    )}
                                    {orderKey === 'name' && orderDir === 'desc' && (
                            ...
                            <FilterButton onClick={toggleSort('isSelected')}>
                                ...
                                <Box width="18px">
                                    {orderKey === 'isSelected' && orderDir === 'asc' && (
                                        <ArrowUpIcon width="18px" color="secondary" />
                                    )}
                                    {orderKey === 'isSelected' && orderDir === 'desc' && (
                                        <ArrowDownIcon width="18px" color="secondary" />
                                    )}
                                </Box>
                            </FilterButton>
