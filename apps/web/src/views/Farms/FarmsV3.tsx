        ...
        const sortFarms = (farms: V2StakeValueAndV3Farm[]): V2StakeValueAndV3Farm[] => {
            switch (sortOption) {
                case 'apr':
                    return orderBy(
                        farms,
                        (farm) => (farm.version === 3 ? +farm.cakeApr : farm.apr ?? 0),
                        'desc'
                    );
                case 'multiplier':
                    return orderBy(
              ...
              <Box>
                <BCakeBoosterCard />
                        ...
                        {!isLoading && !!cakePerSecond && cakePerSecond === '0' && (
                            ...
                            >
                                <MessageText>
                                    CAKE reward emissions for V3 farms have yet to start. You can
                                    stake your LPs now. Once CAKE emission begins on V3, you will
                                    begin earning CAKE.{' '}
                                    <Link
                                        fontSize="14px"
                                    ...
                                    <MessageText bold>
                                        ETA: ~
                                        {differenceInHours(EXPECTED_V3_EPOCH_TIME, Date.now())}{' '}
                                        hours
                                    </MessageText>
                                </MessageText>
                            </Message>
