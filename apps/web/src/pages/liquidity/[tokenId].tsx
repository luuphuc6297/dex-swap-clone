...
export default function PoolPage() {
    ...
    const collect = useCallback(() => {
        ...
        const { calldata, value } = interfaceManager.collectCallParameters({
            ...
            expectedCurrencyOwed0:
                feeValue0 ?? CurrencyAmount.fromRawAmount(currency0ForFeeCollectionPurposes, 0),
            expectedCurrencyOwed1:
                feeValue1 ?? CurrencyAmount.fromRawAmount(currency1ForFeeCollectionPurposes, 0),
            recipient: account,
        });
        ...
        <>
            <LightGreyCard mb="16px">
                <AutoRow justifyContent="space-between" mb="8px">
                    ...
                    <Text>
                        {feeValueUpper ? formatCurrencyAmount(feeValueUpper, 4, locale) : '-'}
                    </Text>
                </AutoRow>
                <AutoRow justifyContent="space-between">
                    ...
                    <Text>
                        {feeValueLower ? formatCurrencyAmount(feeValueLower, 4, locale) : '-'}
                    </Text>
                </AutoRow>
            </LightGreyCard>
    ...
    const isLoading =
        loading || poolState === PoolState.LOADING || poolState === PoolState.INVALID || !feeAmount;
    ...
    return (
        <>
            {!isLoading && (
                <NextSeo
                    title={`${currencyQuote?.symbol}-${currencyBase?.symbol}LP #${tokenIdFromUrl}`}
                />
            )}
            <BodyWrapper>
                {isLoading ? (
                                    ...
                                    >
                                        <Flex position="absolute" right={0}>
                                            <AprCalculator
                                                ...
                                                tokenAmount0={
                                                    inRange ? position?.amount0 : undefined
                                                }
                                                tokenAmount1={
                                                    inRange ? position?.amount1 : undefined
                                                }
                                            />
                                        </Flex>
                                        <Text
                                ...
                                <Flex mb="8px">
                                    <Flex ml="auto" alignItems="center">
                                        ...
                                        <Toggle
                                            ...
                                            checked={receiveWETH}
                                            onChange={() =>
                                                setReceiveWETH((prevState) => !prevState)
                                            }
                                        />
                                    </Flex>
                                </Flex>
        ...
        return (
            <Box>
                <AutoRow gap="8px">
                    ...
                    />
                    <Text ellipsis>
                        {dayjs(+positionTx.timestamp * 1_000).format('YYYY/MM/DD')}
                    </Text>
                </AutoRow>
